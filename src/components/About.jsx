...
const ServiceCard = ({ index, title, icon }) => { //can be changed from index.js
  return (
...
const About = () => {
  return (
    <>
      ...
      >
        Hello! I am currently a student at the University of Virginia (UVA). In my free time, 
        I love to program, swim, read, hike, run, and play sports with friends! 
        I also love to travel. Last summer I was fortunate enough to visit Iceland, 
